...
def rys_3c2e_symm_old(basis, auxbasis, slice=None, schwarz=False, threshold_schwarz=1e-9):
    """
    ...
    .. note::
        This is the legacy implementation that loops over individual
        basis-function triples. It has been superseded by the shell-blocked
        :func:`rys_3c2e_symm`, which is roughly twice as fast, and is retained
        as the fallback used when more than 10 Rys roots are required.
    ...
    Examples
    --------
    >>> ints = rys_3c2e_symm_old(basis, auxbasis)
    >>> ints_block = rys_3c2e_symm_old(basis, auxbasis, slice=[0, 5, 0, 5, 0, 10])
    >>> ints_screened = rys_3c2e_symm_old(basis, auxbasis, schwarz=True, threshold_schwarz=1e-10)
    """
