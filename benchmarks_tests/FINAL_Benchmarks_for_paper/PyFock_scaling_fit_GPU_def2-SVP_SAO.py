...
# -----------------
nbf = np.array([240, 480, 768, 1128, 1824, 2400, 3336], dtype=float)
total_time = np.array([0.183076923,0.403846154,0.707333333,1.259375,2.788823529,4.65625,9.442857143], dtype=float)
j_time = np.array([0.052307692,0.150769231,0.295333333,0.598125,1.444705882,2.705625,6.099285714], dtype=float)
xc_time = np.array([0.081538462,0.159230769,0.256,0.3975,0.744117647,1.0225,1.568571429], dtype=float)
