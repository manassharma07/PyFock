...
# This example shows how to calculate the 2c2e ERI array using the basis set object created.
...
ERI = Integrals.rys_2c2e_symm(basis)
print(ERI) 
...
ERI_subset = Integrals.rys_2c2e_symm(basis, slice=[indx_startA, indx_endA, indx_startB, indx_endB])
print(ERI_subset[:, :]) 
...
print(Integrals.rys_2c2e_symm(basisBig))
